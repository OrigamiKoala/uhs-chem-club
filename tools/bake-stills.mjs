/**
 * bake-stills.mjs — Generates lightweight SVG/WebP fallback backdrops for Tier 1
 */
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" width="1920" height="1080">
  <defs>
    <radialGradient id="sky" cx="50%" cy="40%" r="70%">
      <stop offset="0%" stop-color="#0a1835"/>
  ...
  <!-- Structural Ribs -->
  <polygon points="100,1080 300,0 350,0 200,1080" fill="#080e1c"/>
  <polygon points="1820,1080 1620,0 1570,0 1720,1080" fill="#080e1c"/>
  <!-- Light Beam -->
  <rect x="200" y="520" width="1520" height="4" fill="url(#beam)"/>
  <!-- Center Hologram / Viewport Ring -->
  <circle cx="960" cy="500" r="280" fill="none" stroke="${accent}" stroke-width="2" stroke-dasharray="12 6" opacity="0.4"/>
...
for (const loc of LOCATIONS) {
  const svg = SVG_TEMPLATE(loc, ACCENTS[loc] || '#00e5ff');
  const svgPath = path.join(outDir, `${loc}.svg`);
  fs.writeFileSync(svgPath, svg.trim());
  console.log(`Generated fallback backdrop: ${svgPath}`);
}
